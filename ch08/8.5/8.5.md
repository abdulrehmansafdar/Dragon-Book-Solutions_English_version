...
- "Construct the basic block" is translated as "construct DAG", is this what it means?
...
Section 8.5.6 talks about pointer assignment and there is no demo here!!!

- Is `*p = c` and `c = *p` translated into DAG like this:![screen shot 2013-10-19 at 4 27 34pm](https://f.cloud.github.com/assets/340282/1365867/563bfc66-3898-11e3-9b2b-f536f294e165.png)
- How to express a statement like `*p = a[i]` using DAG?
- Section 8.5.6 mentioned: the operator =* must take all nodes that are currently associated with identifiers as arguments.How to express this sentence in DAG?
