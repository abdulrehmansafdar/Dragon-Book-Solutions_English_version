# Exercises in Section 3.7

### 3.7.1

Convert the NFA in the image below to a DFA.
...
Use Algorithm 3.22 to simulate the process of the NFA in the figure below when processing the input aabb.
...
Convert the following regular expression into a DFA using Algorithms 3.23 and 3.20.
